            ...
            <div class="row py-2 ">
                ...
                <div class="col-6 col-md-4">
                    <div class="d-flex flex-row-reverse bd-highlight">
                        <a class="btn btn-primary"  href="<?php  echo base_url('SaranaPrasarana/formTambahRuangan'); ?>" role="button">Tambah Ruangan</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <table class="table table-bordered">
            ...
            ?>
                <tr class="text-center">
                    ...
                    <td >
                        <a href="<?php echo site_url('SaranaPrasarana/updateRuangan/'.$u->id_ruangan); ?>"  class="btn btn-warning text-white" title="Edit">
                        <i class="fas fa-pencil-alt"></i>
                        </a>
                        <a href="<?php echo site_url('SaranaPrasarana/hapusRuangan/'.$u->id_ruangan); ?>"  class="btn btn-danger text-white"  title="Hapus">
