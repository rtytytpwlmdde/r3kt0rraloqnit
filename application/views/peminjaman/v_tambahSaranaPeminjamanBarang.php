        ...
        <form class="user" method="post">
            ...
            <div class="d-block my-3"><?php $jumRuangan = 0; $operator=null;
                ...
                <div class="custom-control custom-radio py-1">
                    ...
                    <a href="<?php echo site_url('Peminjaman/hapusSaranaPeminjaman/'.$jenis_peminjaman.'/'.$id.'/'.$a->id_sarana.'/'.$tgl_mulai.'/'.$tgl_selesai.'/'.$jam_mulai.'/'.$jam_selesai); ?>"  class="btn btn-danger btn-sm text-white" title="Hapus Barang">
            ...
            <?php if($jumRuangan == 0){ ?>
                <a href="<?php echo site_url('Peminjaman/hapusPeminjaman/'.$id); ?>"   type="submit" class="btn btn-warning btn-user btn-block" title="Selesaikan Peminjaman Barang">
                    Batalkan Peminjaman
                </a>
            <?php }else{ ?>
