  ...
  <div class="row mt-4">
    <div class="col-md-4 order-md-2 mb-4">
      ...
      <form class="card p-2" >
        ...
        <label>Tekan tombol kirim peminjaman setelah ruangan ditambahkan</label>
          <div class="" >
            <button type="submit" style="widht:100%" class="btn btn-secondary">Kirim Peminjaman</button>
          </div>
        </div>
      </form>
    </div>
    <div class="col-md-8 order-md-1">
      ...
      <form class="user" action="<?php echo base_url().'Peminjaman/tambahPeminjamanNonKelas'; ?>" method="post">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Panduan Mengisi Form</h5>
