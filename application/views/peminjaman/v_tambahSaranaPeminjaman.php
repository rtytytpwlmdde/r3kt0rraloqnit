        ...
        foreach ($peminjaman as $u){ ?>
            ...
            <div class="d-block my-3"><?php $jumRuangan = 0; $operator=null;
                ...
                <div class="custom-control custom-radio py-1">
                    ...
                    <a href="<?php echo site_url('index.php?/Peminjaman/hapusSaranaPeminjaman/'.$jenis_peminjaman.'/'.$id.'/'.$a->id_sarana.'/'.$tgl_mulai.'/'.$tgl_selesai.'/'.$jam_mulai.'/'.$jam_selesai); ?>"  class="btn btn-danger btn-sm text-white" title="Hapus Ruangan">
            ...
            <form action="<?php echo base_url("index.php?/Peminjaman/kirimPeminjaman")?>" method="post">
                ...
                <?php }else{?>
                    ...
                    <div class="col-md-9"> 
                        <a href="<?php echo site_url('index.php?/Peminjaman/formTambahTagihanPeminjaman/'.$id); ?>"   type="submit" class="btn btn-user btn-block btn-primary " title="Batalkan peminjaman">
