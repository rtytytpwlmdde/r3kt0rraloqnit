...
<body id="page-top">
  ...
  <div id="wrapper">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo base_url('index.php?/User/user'); ?>">User</a>
    ...
    <?php }?>
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('index.php?/Peminjaman/formCekPeminjaman'); ?>">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-biru topbar mb-2 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li hidden class="nav-item dropdown no-arrow mx-1"><?php foreach($jumlahPeminjaman as $u){ $jumPeminjaman =  $u->jumPeminjamanTerkirim; } $a = $jumPeminjaman?>
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <form class="dropdown-item" action="<?php  echo base_url('index.php?/Peminjaman/historyPeminjaman'); ?>" method="post"><input hidden name="statusa" value="terkirim">
            ...
            <!-- Nav Item - Alerts -->
            <?php if($this->session->userdata('status') == "admin"){ ?>
            <li hidden class="nav-item dropdown no-arrow mx-1"><?php foreach($jumlahUser as $u){ $jumUser =  $u->jumUserBaru; }?>
              <a class="nav-link dropdown-toggle text-white" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
